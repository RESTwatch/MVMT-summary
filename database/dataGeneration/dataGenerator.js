...
const opts = {headers: false, quote: "'"};
...
fs.appendFile('/Users/miles/Desktop/Hack_reactor/sdc/MVMT-summary/database/dataGeneration/seedWatchData1.csv', `${firstWatchFile.id}, ${firstWatchFile.wid}, '${firstWatchFile.watch_name}', '${firstWatchFile.series}', ${firstWatchFile.size}, ${firstWatchFile.watch_price}` + '\n');
...
const generateCSVRecord = (id, recordsPerFile) => {
  ...
  let csvStr = `${record.id}, ${record.wid}, '${record.watch_name}', '${record.series}', ${record.size}, ${record.watch_price}` + '\n';
...
fs.appendFile('/Users/miles/Desktop/Hack_reactor/sdc/MVMT-summary/database/dataGeneration/seedStrapData1.csv', `${firstStrapOptionsFile.watch_id}, ${firstStrapOptionsFile.strap_id}` + '\n');
